...
/**
 * Execute code via E2B sandbox API
 */
async function e2bExecute(code: string, language: string): Promise<CodeExecOutput> {
  ...
  // Wrap TypeScript for Node execution
...
/**
 * Simple local JavaScript eval (for when E2B is not configured)
 * WARNING: This is NOT fully sandboxed — only for development use
 */
